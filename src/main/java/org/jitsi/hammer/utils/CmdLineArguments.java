...
public class CmdLineArguments
{
    ...
    @Option(name="-h", aliases= { "--help", "-help" }, 
            usage="Get help and usage"
        + " to run the program")
     ...
     */
    @Option(name="-XMPPdomain",usage="The XMPP domain name")
    private String XMPPdomain;

    /**
     * The hostname used to access the BOSH server.
     */
    @Option(name="-BOSHhost",usage="The XMPP server hostname")
     ...
     */
    @Option(name="-MUCdomain",usage="The MUC domain name")
     ...
     */
    @Option(name="-BOSHpath",usage="The BOSH path to use")
     ...
     */
    public HostInfo getHostInfoFromArguments() throws URISyntaxException
    {
        ...
        if (BOSHhost != null) 
        {
            hostInfo.setBOSHhost(BOSHhost);
        }
        
        if (BOSHpath != null) 
        {
            hostInfo.setBOSHpath(BOSHpath);
        }
        
        if (XMPPdomain != null)
        {
            hostInfo.setXMPPdomain(XMPPdomain);
        }
        ...
        if (MUCdomain != null)
        {
            hostInfo.setMUCdomain(MUCdomain);
        }
